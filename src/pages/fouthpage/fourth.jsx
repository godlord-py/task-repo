    ...
    return (
        <div className="first bg-white min-h-screen relative">
            ...
            <div className=" absolute mt-32 w-11/12 grid grid-cols-1 md:grid-cols-3 gap-42" style={{ top: "116%", left: "17%", transform: "translate(-15%, -30%)" }}>
                <div className="bg-white p-2 rounded-md border-b border-gray-400 text-center h-full transition duration-500 hover:bg-yellow-200">
                ...
                <div className="bg-white p-2 rounded-md border-b border-gray-400 text-center h-full transition duration-500 hover:bg-orange-200">
                ...
                <div className="bg-white p-2 rounded-md border-b border-gray-400 text-center h-full transition duration-500 hover:bg-gray-200">
