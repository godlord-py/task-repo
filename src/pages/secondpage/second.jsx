...
const SecondPage = () => {
    return (    
        <div className="second bg-[#fff8e8] min-h-screen relative">
            <img
                src={Image2}
                className="absolute left-20 top-0  w-1/3 h-3/4 object-cover transition-all duration-1000 hover:rounded-r-full"
            />
